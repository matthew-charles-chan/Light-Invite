...
const pickDate = function (userId, db) {
  ...
  if(!pickMade) {
    pick = 58
    // getEventIdWithUserId(userId, db)
    // .then ( res => {
    //   return db.query(`
    //   SELECT dates.id
    //   FROM DATES
...
module.exports =  { addEvent, addDate, addUserGuest, getIdFromEmail, getStartEnd, pickDate, updateNameByUserId, makeAvailable, notAvailable, DeleteVote, creatorId, getVoteCount, getEventIdWithUserId, checkIfVoted, getUsersInfoWithEventId, getUserByUserId, updateEmailByUserId};
