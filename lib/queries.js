...
const getNameByUserId = function(userId, db) {
  return db.query(`
    SELECT name
    FROM users
    WHERE users.id = $1
...
module.exports =  { addEvent, addDate, addUserGuest, getIdFromEmail, getStartEnd, pickDate, updateNameByUserId, makeAvailable, notAvailable, DeleteVote, creatorId, getVoteCount, getEventIdWithUserId, checkIfVoted, getUserInfoWithEventId, getNameByUserId};
