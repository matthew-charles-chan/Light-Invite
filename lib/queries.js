...
const incrementYes = function (dateId, userId, db) {
  return db.query(`
  INSERT INTO votes (date_id, user_id, yes_count)
  VALUES ($1, $2, $3)
  `, [dateId, userId, 1])
}
...
// Increment no_count
const incrementNo = function (dateId, userId, db) {
  return db.query(`
  INSERT INTO votes (date_id, user_id, no_count)
  VALUES ($1, $2, $3)
  `, [dateId, userId, 1])
}
...
module.exports =  { addEvent, addDate, addUserGuest, getIdFromEmail, getStartEnd, pickDate, updateNameByUserId, incrementNo, incrementYes};
